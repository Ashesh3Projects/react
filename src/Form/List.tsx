...
function FormList() {
	...
	return (
		<main className="p-6 mx-auto bg-white shadow-lg rounded-xl min-w-[600px] items-center">
			<NavBar />
			<div className="w-full items-center center text-center">
				<Search search={search} setQuery={setQuery} />
				<h1
					className="pb-2 w-full text-center text-xl items-center font-semibold border-b-[1px] border-gray-600 border-dashed"
					tabIndex={0}
				>
					Form List
				</h1>
